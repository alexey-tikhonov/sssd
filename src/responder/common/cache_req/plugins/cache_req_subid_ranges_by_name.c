...
static errno_t
cache_req_subid_ranges_by_name_ncache_check(struct sss_nc_ctx *ncache,
                                            struct sss_domain_info *domain,
                                            struct cache_req_data *data)
{
...
static errno_t
cache_req_subid_ranges_by_name_ncache_add(struct sss_nc_ctx *ncache,
                                          struct sss_domain_info *domain,
                                          struct cache_req_data *data)
{
...
const struct cache_req_plugin cache_req_subid_ranges_by_name = {
    ...
    .ncache_check_fn = cache_req_subid_ranges_by_name_ncache_check,
    .ncache_add_fn = cache_req_subid_ranges_by_name_ncache_add,
